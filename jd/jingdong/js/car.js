(function(){
	...
	var products = [
		{
			name:"纸巾",
			pic:"./img/side-banner01.jpg.webp",
			price:49.90,
			id:1
		},
		{
			name:"鼠标",
			pic:"./img/side-banner02.jpg.webp",
			price:99.00,
			id:2
		},
		{
			name:"电脑",
			pic:"./img/item-banner03.jpg.webp",
			price:4350.00,
			id:3
		},
		{
			name:"手机",
			pic:"./img/item-banner05.jpg.webp",
			price:3250.00,
			id:4
		}
	]
	...
	class ShoppingCart{
		constructor(containerId,products){
			...
			this.shopList.className = "table table-striped table-hover";
			this.cartList = document.createElement('table');//购物车列表
			this.cartList.className = "table table-striped table-hover";
